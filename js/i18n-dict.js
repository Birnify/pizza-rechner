...
(function (global) {
  ...
  // Bebildertes Preset-Kartengitter (v4.32.0, "Bild-Grundgerüst plus bebildertes
  // Preset-Kartengitter" -- ersetzt die 3 Empfehlungskarten aus v3.71.0/preset.recommend.*
  // durch 9 gleichrangige Karten, eine je Rezept, mit Bild aus dem Register js/images.js.
  // Jede Karte: Name, Gärzeit, kurze Eignung -- dieselbe Struktur wie zuvor, jetzt für alle
  // Rezepte statt nur 3. aria-label je Karte im etablierten "Name: Zeit Gärzeit, Eignung"-
  // Muster (s. v3.71.0-Accessibility-Befund unten). Seit v4.33.6: "Rezept X von 9: "-Präfix
  // (Positionsangabe fürs Durchtabben, accessibility-expert-Nice-to-have aus dem v4.33.0-
  // Review, dort bewusst zurückgestellt) -- die Zahl X ist die feste Reihenfolge im Markup
  // (pizza-rechner.html/-mobile.html, .preset-grid), nicht laufzeit-berechnet: schnell(1),
  // napoliKlassisch(2), napoliKalt(3), napoliBigaKlassisch(4), napoliBigaKalt(5),
  // napoliPoolishSchnell(6), napoliPoolishKalt(7), teglia(8), newyorkStyle(9). Eigene
  // gespeicherte Rezepte laufen weiterhin nur über das #preset-Dropdown, nicht über
  // Bild-Karten -- keine weitere Stelle betroffen.
  add('preset.grid.groupLabel', 'Rezepte', 'Recipes');
  // accessibility-expert-Befund (v3.71.0, MAJOR 1, weiterhin gültig): der Accessible Name
  // eines preset-card-Buttons darf nicht die kommentarlose Aneinanderreihung von
  // Name+Zeit+Eignung ohne Trennzeichen sein (z. B. "Schnell 4–6 h Für spontane Pizza am
  // selben Tag") -- eigene aria-label-Texte mit Doppelpunkt/Komma-Struktur je Karte.
  ...
  add('preset.grid.schnell.ariaLabel', 'Rezept 1 von 9: Schnell, 4–6 h Gärzeit, locker-luftig für spontane Abende',
    'Recipe 1 of 9: Quick, 4–6 h rise time, light and airy for a spontaneous night');
  ...
  // unverändert, s. preset.napoliKlassisch.desc oben für die ausführliche Erklärung. Name
  // seit v4.32.0 "Napoli Klassisch" statt nur "Klassisch" (Konsistenz mit den 6 neu
  // hinzugekommenen Karten, die alle den vollen Rezeptnamen tragen).
  ...
  add('preset.grid.napoliKlassisch.ariaLabel', 'Rezept 2 von 9: Napoli Klassisch, ~28 h Gärzeit, ausgewogener AVPN-Klassiker',
    'Recipe 2 of 9: Napoli Classic, ~28 h rise time, balanced classic, AVPN inspired');
  ...
  add('preset.grid.napoliKalt.ariaLabel', 'Rezept 3 von 9: Napoli Lange Kaltgare, ~44 h Gärzeit, komplexes Aroma, lange Kaltgare',
    'Recipe 3 of 9: Napoli Long Cold Rise, ~44 h rise time, complex flavor, long cold rise');
  ...
  add('preset.grid.napoliBigaKlassisch.ariaLabel', 'Rezept 4 von 9: Biga klassisch, ~29 h Gärzeit, röstaroma, offene Krume',
    'Recipe 4 of 9: Biga classic, ~29 h rise time, rich toasted flavor, open crumb');
  ...
  add('preset.grid.napoliBigaKalt.ariaLabel', 'Rezept 5 von 9: Biga kalt, ~60 h Gärzeit, kräftigeres Aroma, extra lange Reife',
    'Recipe 5 of 9: Biga cold, ~60 h rise time, even richer flavor, extra long rise');
  ...
  add('preset.grid.napoliPoolishSchnell.ariaLabel', 'Rezept 6 von 9: Poolish schnell, ~20 h Gärzeit, mild im Geschmack, sehr luftige Krume',
    'Recipe 6 of 9: Poolish fast, ~20 h rise time, mild flavor, very airy crumb');
  ...
  add('preset.grid.napoliPoolishKalt.ariaLabel', 'Rezept 7 von 9: Poolish kalt, ~34 h Gärzeit, mild, aromatisch durch kalte Reife',
    'Recipe 7 of 9: Poolish cold, ~34 h rise time, mild yet aromatic from a cold rise');
  ...
  add('preset.grid.teglia.ariaLabel', 'Rezept 8 von 9: Teglia, ~76 h Gärzeit, knusprig-luftige Blechpizza',
    'Recipe 8 of 9: Teglia, ~76 h rise time, crispy, airy pan pizza, Roman style');
  ...
  add('preset.grid.newyorkStyle.ariaLabel', 'Rezept 9 von 9: New York Style, ~44 h Gärzeit, dünn, knusprig, klassisch faltbar',
    'Recipe 9 of 9: New York Style, ~44 h rise time, thin, crispy, classic foldable slice');

...
(function (global) {
  ...
  add('preset.grid.napoliKlassisch.fit', 'Neapolitanischer AVPN-Klassiker', 'Neapolitan AVPN classic');
  ...
  add('preset.grid.napoliKalt.fit', 'Maximales Aroma, Mehl W300+', 'Maximum flavor, flour W300+');
  ...
  add('preset.grid.napoliBigaKlassisch.fit', 'Röstaromen, offene Krume', 'Toasted flavor, open crumb');
  ...
  add('preset.grid.napoliBigaKalt.fit', 'Vorteig kalt, intensives Aroma', 'Pre-ferment cold, intense flavor');
  ...
  add('preset.grid.napoliPoolishKalt.fit', 'Vorteig kalt, milder Teig', 'Pre-ferment cold, mild dough');
  ...
  add('preset.grid.teglia.fit', 'Römische Blechpizza (W330+)', 'Roman pan pizza (W330+)');
  ...
  add('preset.grid.newyorkStyle.fit', 'Dünne Kruste, Mehl W300+', 'Thin crust, flour W300+');
